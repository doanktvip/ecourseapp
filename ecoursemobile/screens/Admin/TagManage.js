        ...
        <View style={Styles.container}>
            <View style={{ padding: 16, paddingBottom: 0 }}>
                <TouchableOpacity style={Styles.btnAdd} onPress={() => openModal()}>
                    <Ionicons name="add" size={24} color={theme.colors.white} style={{ marginRight: 8 }} />
                    ...
                    >
                        ...
                        >
                            ...
                            <View style={[Styles.modalActions, { width: '100%' }]}>
                                <TouchableOpacity style={Styles.modalBtnSecondary} onPress={closeModal} disabled={submitting}>
                                    <Text style={Styles.btnSecondaryText}>HỦY BỎ</Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    style={[Styles.modalBtnPrimary, submitting && { opacity: 0.7 }]}
                                    onPress={handleSave}
                                    disabled={submitting}
                                >
                                    {submitting ? (
