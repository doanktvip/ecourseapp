            ...
            <ScrollView style={[Styles.container, { padding: 20 }]} showsVerticalScrollIndicator={false}>
                <View style={{ paddingVertical: 60, alignItems: 'center' }}>
                    ...
                    <Text style={[Styles.body, { textAlign: 'center', marginBottom: 30, paddingHorizontal: 15 }]}>
                        Tài khoản hiện tại của bạn là <Text style={{ fontWeight: 'bold' }}>Học viên</Text>. Chức năng tạo khóa học mới chỉ khả dụng đối với vai trò <Text style={{ fontWeight: 'bold', color: theme.colors.primary }}>Giảng viên</Text> của hệ thống eCourse.
                    </Text>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={Styles.container}>
            <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 50 }} keyboardShouldPersistTaps="handled">
                <View style={Styles.formContainer}>
                    ...
                    >
                        <Text style={Styles.formLabel}>Tên khóa học <Text style={{ color: theme.colors.danger }}>*</Text></Text>
                        <TextInput
                            value={subject}
                    ...
                    <View style={Styles.formGroup}>
                        <Text style={Styles.formLabel}>Danh mục khóa học <Text style={{ color: theme.colors.danger }}>*</Text></Text>
                        <TouchableOpacity
                    ...
                    >
                        ...
                        <TextInput
                            ...
                            mode="outlined"
                            style={{ backgroundColor: theme.colors.white, minHeight: 100 }}
                        ...
                        >
                            {imageUri ? (
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    ...
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', color: theme.colors.text }}>Chọn ảnh bìa thiết kế</Text>
                    ...
                    {course && (
                        <View style={{ marginTop: 16 }}>
                            <Button
                                ...
                                style={{ backgroundColor: theme.colors.danger, borderRadius: 8, paddingVertical: 4 }}
                                labelStyle={{ fontSize: 16, fontWeight: 'bold', color: theme.colors.white }}
